...
for file in html_files:
    ...
    for v in range(1, 10):
        ...
        if old_css in content:
            content = content.replace(old_css, '<link rel="stylesheet" href="css/style.css?v=6">')
            
    old_css_base = '<link rel="stylesheet" href="css/style.css">'
    if old_css_base in content:
        content = content.replace(old_css_base, '<link rel="stylesheet" href="css/style.css?v=6">')
